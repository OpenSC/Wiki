...
* or by becoming a fellow in the [Free Software Foundation Europe](https://fsfe.org/) which uses the OpenPGP Card specification on the [Fellowship Smart Cards](https://www.gnupg.org/howtos/card-howto/en/smartcard-howto-single.html) it hands out to its fellows.
